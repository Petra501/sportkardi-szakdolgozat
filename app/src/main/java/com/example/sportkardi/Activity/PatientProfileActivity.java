...
public class PatientProfileActivity extends AppCompatActivity {
    ...
    private static final String TAG = PatientProfileActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsLinearLayout.setOnClickListener(v -> {
            Intent intent = new Intent(PatientProfileActivity.this, PatientSettingsActivity.class);
        ...
        addBloodPressureFAB.setOnClickListener(v -> {
            Intent intent = new Intent(PatientProfileActivity.this, PatientBloodPressureActivity.class);
            intent.putExtra("KEY", KEY);
            intent.putExtra("personalId", personalId);
            intent.putExtra("name", name);
            startActivity(intent);
        ...
        infoLinearLayout.setOnClickListener(v -> {
            ...
            TapTargetSequence sequence = new TapTargetSequence(PatientProfileActivity.this)
                    .targets(
                    ...
                    .listener(new TapTargetSequence.Listener() {
                        ...
                        public void onSequenceCanceled(TapTarget lastTarget) {
                            Toast.makeText(PatientProfileActivity.this, "Útmutató megszakítva.", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    private void showSuccessfulDialog() {
        ...
        View view = LayoutInflater.from(PatientProfileActivity.this).inflate(R.layout.dialog_successful_delete, dialogConstraintLayout);
                        ...
                        if (!name.equals(dbName)) {
                            db.collection("users").document(document.getId())
                                    ...
                                    .addOnFailureListener(e ->
                                            Toast.makeText(PatientProfileActivity.this, "Hiba történt a frissítés közben", Toast.LENGTH_LONG).show());
                        } else {
                            Toast.makeText(PatientProfileActivity.this, "Nem történt módosítás", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(PatientProfileActivity.this, "Felhasználó nem található", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(e -> Toast.makeText(PatientProfileActivity.this, "Hiba történt az adatbázis elérése közben", Toast.LENGTH_LONG).show());
    }
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && !task.getResult().isEmpty()) {
                        ...
                        if (!Objects.equals(hashedPassword, "") && !hashedPassword.equals(dbPassword)) {
                            ...
                            Toast.makeText(PatientProfileActivity.this, "Nincs frissítendő adat", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(PatientProfileActivity.this, "Felhasználó nem található", Toast.LENGTH_LONG).show();
                    }
