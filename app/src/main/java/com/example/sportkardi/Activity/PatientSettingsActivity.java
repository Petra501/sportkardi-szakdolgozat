...
public class PatientSettingsActivity extends AppCompatActivity {
    private static final String TAG = PatientSettingsActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileLinearLayout.setOnClickListener(v -> {
            Intent intent = new Intent(PatientSettingsActivity.this, PatientProfileActivity.class);
        ...
        addBloodPressureFAB.setOnClickListener(v -> {
            Intent intent = new Intent(PatientSettingsActivity.this, PatientBloodPressureActivity.class);
            intent.putExtra("KEY", KEY);
            intent.putExtra("personalId", personalId);
            intent.putExtra("name", name);
            startActivity(intent);
        ...
        infoLinearLayout.setOnClickListener(v -> {
            ...
            TapTargetSequence sequence = new TapTargetSequence(PatientSettingsActivity.this)
                    .targets(
                    ...
                    .listener(new TapTargetSequence.Listener() {
                        ...
                        public void onSequenceCanceled(TapTarget lastTarget) {
                            Toast.makeText(PatientSettingsActivity.this, "Útmutató megszakítva.", Toast.LENGTH_SHORT).show();
                        }
                    });
